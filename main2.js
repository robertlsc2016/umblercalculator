...
main = () => {
    ...
    if(document.getElementById('dataInicial').value !== ''){
        if(document.getElementById('dataFinal').value !== ''){
            if(document.getElementById('dataContabilizacao').value !== ''){
                if(document.getElementById('dataUsado').value !== '' ){
                    if(document.getElementById('valordoplano').value !== ''){
                        ...
                        let vPlano = document.getElementById('valordoplano').value
                    
                        if(vPlano.indexOf(',') !== -1){
                            vPlano = document.getElementById('valordoplano').value.replace(',', '.')   
                            console.log(vPlano)
                        }
                        
                        const vDiario = vPlano / diasPlano
                        ...
                        document.getElementById('saldoRestanteValue').innerHTML = vRestante.toFixed(2)
                        ...
                        alert('VALOR DO PLANO NÃO INFORMADO')
                    }
                }else{
                    alert("DATA DE FINALIZAÇÃO NÃO INFORMADA")
                }
            } else{
                alert('DATA DE CONTABILIZÇÃO NÃO INFORMADA')
            }
        }else{
            alert('DATA FINAL DA FATURA NÃO INFORMADA')
        }
    }else{
...
noVencimento = () => {
    if(document.getElementById('dataInicial').value == ''){
        ...
        document.getElementById('dataContabilizacao').value = document.getElementById('dataInicial').value
